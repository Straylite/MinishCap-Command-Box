...
if commandmouse["X"] >= 1 and commandmouse["X"] <= 100 and commandmouse["Y"] >= 150 and commandmouse["Y"] <= 158 and commandmouse["Left"] and commandSwitch == false then
commandState = true
commandSwitch = true
elseif commandmouse["X"] >= 101 and commandmouse["X"] <= 239 and commandmouse["Y"] >= 0 and commandmouse["Y"] <= 160 and commandmouse["Left"] and commandSwitch == false then
commandState = false
commandSwitch = true
elseif commandmouse["X"] >= 0 and commandmouse["X"] <=99 and commandmouse["Y"] >= 0 and commandmouse["Y"] <= 149 and commandmouse["Left"] and commandSwitch == false then
commandState = false
commandSwitch = true
end
